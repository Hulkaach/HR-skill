...
public class CandidateRepositoryJDBCImpl implements CandidateRepository {
    ...
    private static final String PASSWORD = "new_passwd2";
    ...
    public Candidate save(Candidate candidate) {
        ...
        try {
            ...
            stmt.setObject(2, candidate.getFio());
            stmt.setObject(3, candidate.getAge());
            stmt.setObject(4, candidate.getPosition());
            stmt.setObject(5, candidate.getCvInfo());
            stmt.setObject(6, candidate.getStatus().name());
